"""
FIR-based up- and down-sampling layers.

Adapted from yang-song/score_sde_pytorch (Apache-2.0), which in turn
ports several functions from NVlabs/stylegan2. See
...
import numpy as np
from models.ncsnpp.op import upfirdn2d
