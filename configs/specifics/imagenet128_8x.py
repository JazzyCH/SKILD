"""
ImageNet 128 / 8 x super-resolution (16 -> 128) / NCSN++.

Schedule and architecture used by the continuous-SR figure on
ImageNet-128 (paper Sec. 5.2).
Effective resolution at sampling start is set so that frequencies up to
k = 16 sit above the SNR threshold tau = 0.1.
"""
...
def get_config():
    ...
    training.gt_forward_k_path = "/path/to/data/imagenet128_16_val.pt"
